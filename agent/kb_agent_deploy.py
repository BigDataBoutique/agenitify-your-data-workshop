...
def parse_arguments():
    ...
    parser.add_argument("--agent_name", default="kb_agent2", help="agent name")
...
for key in (
    ...
    "REKOGNITION_ACCESS_SECRET",
    "REKOGNITION_BUCKET_IMAGE_DIR",
    "POSTGRES_USER",
    "POSTGRES_PASSWORD",
    "POSTGRES_JDBC_URL",
):
    ...
    if value:
        env_vars[key] = value
launch_result = agentcore_runtime.launch(env_vars=env_vars if env_vars else None)
print(launch_result)
