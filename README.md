...
3. Add a policy to the AgentCoreRuntimeRole role in the agent environment:
```
{
  "Statement": [
    {
...
6. Test: make sure kb_agent_test.py uses the arn created during deploy, then ```uv run ./kb_agent_test.py```
